...
import { Table, FormGroup, Input, Label, Col, Row } from "reactstrap";
...
const Perhitungan = (props) => {
  ...
  return (
    <div className="animated fadeIn">
      ...
      <Card>
        <Card.Header>
          <i className="fa fa-align-justify"></i> Perhitungan
        </Card.Header>
        <Card.Body>
          {alternatif &&
            alternatif.map((data, i) => {
              return (
                <Fragment key={i}>
        ...
        <Card.Footer>
          ...
          >
            <i className="fa fa-dot-circle-o"></i> Hitung
          </Button>{" "}
        </Card.Footer>
      </Card>
      {/* )
