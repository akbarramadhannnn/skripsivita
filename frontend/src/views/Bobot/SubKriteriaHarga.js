            ...
            <Col md="4">
              <FormGroup>
                ...
                <div style={{ marginBottom: "10px" }}>
                  <Input type="text" value={subKriteria.mahal} disabled />
                </div>
                <div style={{ marginBottom: "10px" }}>
                  <Input type="text" value={subKriteria.mahal} disabled />
                </div>
                ...
                <div style={{ marginBottom: "10px" }}>
                  <Input type="text" value={subKriteria.sedang} disabled />
                </div>
                <div style={{ marginBottom: "10px" }}>
                  <Input type="text" value={subKriteria.sedang} disabled />
                </div>
                <div style={{ marginBottom: "10px" }}>
                  <Input type="text" value={subKriteria.murah} disabled />
                </div>
              </FormGroup>
            </Col>
...
export default SubKriteriaHarga;
