...
const SubKriteria = (props) => {
    ...
    useEffect(() => {
        getDataSubKriteriaByIdKriteria(props.match.params.idkriteria)
        .then(res => {
            if(res.status === true) {
                ...
                <Col xs="12" lg="12">
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Link to={`/subkriteria/tambah/${props.match.params.idkriteria}`}>
                                <Button color="primary">Tambah Sub Kriteria</Button>{' '}
                            </Link>
                            <br />
                            <br />
                            ...
                            <Table className="text-center" responsive>
                                ...
                                {
                                    dataSubKriteria && dataSubKriteria.map((data,i) => {
                                        return (
                                            <Fragment key={i}>
                                                <tbody>
                                                    <tr>
